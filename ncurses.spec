...
%package data
Summary: data components for the ncurses package.
Group: Data
...
Requires: ncurses-bin = %{version}-%{release}
Requires: ncurses-data = %{version}-%{release}
Provides: ncurses-devel = %{version}-%{release}
Requires: ncurses = %{version}-%{release}

%description dev
dev components for the ncurses package.


%package dev32
Summary: dev32 components for the ncurses package.
Group: Default
Requires: ncurses-lib32 = %{version}-%{release}
Requires: ncurses-bin = %{version}-%{release}
Requires: ncurses-data = %{version}-%{release}
Requires: ncurses-dev = %{version}-%{release}
...
%package lib-narrow
Summary: lib-narrow components for the ncurses package.
Group: Default

%description lib-narrow
lib-narrow components for the ncurses package.


%package lib-plusplus
Summary: lib-plusplus components for the ncurses package.
Group: Default

%description lib-plusplus
lib-plusplus components for the ncurses package.
...
%package staticdev
Summary: staticdev components for the ncurses package.
Group: Default
Requires: ncurses-dev = %{version}-%{release}

%description staticdev
staticdev components for the ncurses package.


%package staticdev32
Summary: staticdev32 components for the ncurses package.
Group: Default
Requires: ncurses-dev32 = %{version}-%{release}

%description staticdev32
staticdev32 components for the ncurses package.
...
pushd ..
cp -a ncurses build32
popd
pushd ..
cp -a ncurses build-special
popd
...
export CXXFLAGS="-g -O3 --param=lto-max-streaming-parallelism=16 -march=native -mtune=native -fgraphite-identity -Wall -Wl,--no-as-needed -Wl,--build-id=sha1 -Wl,--enable-new-dtags -Wl,--hash-style=gnu -Wl,-O2 -Wl,-z,relro,-z,now -mprefer-vector-width=256 -falign-functions=32 -flimit-function-alignment -fasynchronous-unwind-tables -fdevirtualize-at-ltrans -floop-nest-optimize -floop-block -fno-math-errno -fno-semantic-interposition -fno-stack-protector -fno-trapping-math -ftree-loop-distribute-patterns -ftree-loop-vectorize -ftree-vectorize -fuse-ld=bfd -fuse-linker-plugin -malign-data=cacheline -feliminate-unused-debug-types -fipa-pta -flto=16 -fno-plt -mtls-dialect=gnu2 -Wl,-sort-common -Wno-error -fvisibility-inlines-hidden -pipe -ffat-lto-objects -fPIC -fomit-frame-pointer -fexceptions -static-libstdc++ -static-libgcc -Wl,--build-id=sha1"
#
...
#
export LDFLAGS="-g -O3 --param=lto-max-streaming-parallelism=16 -march=native -mtune=native -fgraphite-identity -Wall -Wl,--no-as-needed -Wl,--build-id=sha1 -Wl,--enable-new-dtags -Wl,--hash-style=gnu -Wl,-O2 -Wl,-z,relro,-z,now -mprefer-vector-width=256 -falign-functions=32 -flimit-function-alignment -fasynchronous-unwind-tables -fdevirtualize-at-ltrans -floop-nest-optimize -floop-block -fno-math-errno -fno-semantic-interposition -fno-stack-protector -fno-trapping-math -ftree-loop-distribute-patterns -ftree-loop-vectorize -ftree-vectorize -fuse-ld=bfd -fuse-linker-plugin -malign-data=cacheline -feliminate-unused-debug-types -fipa-pta -flto=16 -fno-plt -mtls-dialect=gnu2 -Wl,-sort-common -Wno-error -pipe -ffat-lto-objects -fPIC -fomit-frame-pointer -static-libstdc++ -static-libgcc -Wl,--build-id=sha1"
#
...
export CFLAGS="-Wl,--no-as-needed -m32 -O3 -pipe -fPIC -m32 -mstackrealign -fomit-frame-pointer -fstrict-aliasing -ffast-math -march=native -Wall -fexceptions"
export FCFLAGS="-Wl,--no-as-needed -m32 -O3 -pipe -fPIC -m32 -mstackrealign -fomit-frame-pointer -fstrict-aliasing -ffast-math -march=native -Wall -fexceptions"
export FFLAGS="-Wl,--no-as-needed -m32 -O3 -pipe -fPIC -m32 -mstackrealign -fomit-frame-pointer -fstrict-aliasing -ffast-math -march=native -Wall -fexceptions"
export CXXFLAGS="-Wl,--no-as-needed -m32 -O3 -fvisibility-inlines-hidden -pipe -fPIC -m32 -mstackrealign -fomit-frame-pointer -fstrict-aliasing -ffast-math -march=native -Wall -fexceptions"
export LDFLAGS="-Wl,--no-as-needed -m32 -O3 -pipe -fPIC -m32 -mstackrealign -fomit-frame-pointer -fstrict-aliasing -ffast-math -march=native -Wall -fexceptions"
#
...
/usr/lib32/pkgconfig/32form.pc
/usr/lib32/pkgconfig/32menu.pc
/usr/lib32/pkgconfig/32ncurses++.pc
/usr/lib32/pkgconfig/32ncurses.pc
/usr/lib32/pkgconfig/32panel.pc
/usr/lib32/pkgconfig/32tinfo.pc
...
/usr/share/man/man1/ncurses6-config.1
...
/usr/share/man/man3/alloc_pair.3x
/usr/share/man/man3/alloc_pair_sp.3x
...
/usr/share/man/man3/curses_trace.3x
...
/usr/share/man/man3/erasewchar_sp.3x
/usr/share/man/man3/exit_curses.3x
/usr/share/man/man3/exit_terminfo.3x
/usr/share/man/man3/extended_color_content.3x
/usr/share/man/man3/extended_color_content_sp.3x
/usr/share/man/man3/extended_pair_content.3x
/usr/share/man/man3/extended_pair_content_sp.3x
/usr/share/man/man3/extended_slk_color.3x
/usr/share/man/man3/extended_slk_color_sp.3x
...
/usr/share/man/man3/find_pair.3x
/usr/share/man/man3/find_pair_sp.3x
...
/usr/share/man/man3/free_pair.3x
/usr/share/man/man3/free_pair_sp.3x
...
/usr/share/man/man3/init_extended_color.3x
/usr/share/man/man3/init_extended_color_sp.3x
/usr/share/man/man3/init_extended_pair.3x
/usr/share/man/man3/init_extended_pair_sp.3x
...
/usr/share/man/man3/killwchar_sp.3x
...
/usr/share/man/man3/longname_sp.3x
...
/usr/share/man/man3/new_pair.3x
...
/usr/share/man/man3/reset_color_pairs.3x
/usr/share/man/man3/reset_color_pairs_sp.3x
...
/usr/share/man/man3/tgoto_sp.3x
...
/usr/share/man/man3/tparm_sp.3x
...
/usr/share/man/man3/unfocus_current_field.3x
...
/usr/share/man/man3/use_tioctl_sp.3x
...
/usr/lib64/libform.a
/usr/lib64/libform_g.a
/usr/lib64/libformw.a
/usr/lib64/libformw_g.a
/usr/lib64/libmenu.a
/usr/lib64/libmenu_g.a
/usr/lib64/libmenuw.a
/usr/lib64/libmenuw_g.a
/usr/lib64/libncurses++.a
/usr/lib64/libncurses++_g.a
/usr/lib64/libncurses++w.a
/usr/lib64/libncurses++w_g.a
/usr/lib64/libncurses.a
/usr/lib64/libncurses_g.a
/usr/lib64/libncursesw.a
/usr/lib64/libncursesw_g.a
/usr/lib64/libpanel.a
/usr/lib64/libpanel_g.a
/usr/lib64/libpanelw.a
/usr/lib64/libpanelw_g.a
/usr/lib64/libtinfo.a
/usr/lib64/libtinfo_g.a
/usr/lib64/libtinfow.a
/usr/lib64/libtinfow_g.a

%files staticdev32
%defattr(-,root,root,-)
/usr/lib32/libcurses.a
/usr/lib32/libform.a
/usr/lib32/libform_g.a
/usr/lib32/libmenu.a
/usr/lib32/libmenu_g.a
/usr/lib32/libncurses++.a
/usr/lib32/libncurses++_g.a
/usr/lib32/libncurses.a
/usr/lib32/libncurses_g.a
/usr/lib32/libpanel.a
/usr/lib32/libpanel_g.a
/usr/lib32/libtinfo.a
/usr/lib32/libtinfo_g.a
