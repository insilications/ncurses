...
cd %{_builddir}/ncurses-6.2
pushd ..
cp -a ncurses-6.2 build32
popd
pushd ..
cp -a ncurses-6.2 build-special
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619224968
